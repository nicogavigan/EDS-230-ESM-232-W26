...
# it gives us back X which is the parameter sets it wants us to run
head(sens_P$X)
...
# result is running ODE over a given number of years 
...
allresults = as.data.frame(sens_P$X) |> pmap(p_wrapper, Pinitial=Pinitial, simtimes=simtimes,
