...
# X = the parameters it actually wants to run
...
# if confidence values include a negative, that means it doesnt matter
# if confidence intervals are very wide, you need more samples
# if confidence intervals are high, it is having a hard time estimating
```
...
# could have given the output of the model. but when you do the tell, it is stored in y
...
# c interval is negative in all of these indicating that they don't really interact with each other
```
