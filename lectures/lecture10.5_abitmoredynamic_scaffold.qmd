...
result = diff1(initialC = 10, nx = 10, dx = 1, n = 8, dt = 1, D = 0.5, area = 10)
str(result)
head(result$conc)
...
# me messing around
# these are called numerical overshoot
res1 <- diff1(initialC = 10, nx = 10, dx = 1, n = 8, dt = 1, D = 0.5, area = 10)
filled.contour(res1$conc, xlab = "Time", ylab = "Distance")


res1 <- diff1(initialC = 10, nx = 10, dx = 1, n = 8, dt = 10, D = 5, area = 10)
filled.contour(res1$conc, xlab = "Time", ylab = "Distance")
