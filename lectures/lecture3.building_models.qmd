...
-   Choose the **simplest** model that captures your processes of interest
    -   When you add complexity you add potential for error
...
-   Key factors to include
    ...
    -   Predict streamflow – Necessary output

    -   Must be a spatial model

    -   Has to be able to account for: how does fire affect a streamflow?

        -   What do I have to represent? Why does fire affect streamflow
